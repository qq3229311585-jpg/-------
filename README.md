...
- 想要一个只服务自己的 Telegram 信息助理的人
- 经常问知识、概念、人物、事件、政策类问题的人
- 希望回答有来源、有核查链、可回看日志的人
- 需要把本地工具和搜索能力接到同一个聊天入口里的人

## 典型用法

- 问一个知识问题，bot 自动判断要不要搜
- 问“刚才查了吗”“来源是什么”，bot 去读工具和来源日志
- 问天气、VPS 流量、GitHub Trending、日历这类本地信息，bot 直接走本地工具
- 问长文、传记、复杂争议题，bot 会先采集，再筛选，再写作，再核查
